...
Potato Apparel works with OEKO-TEX Standard 100 fabrics, operates to ISO 9001 quality processes, and can supply GRS documentation for recycled fabrics and OEKO-TEX certificates for children's orders on request. Every order ships with an AQL 2.5 inspection report.
