        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              {/* Facebook — TODO: replace "#" with real URL once page is created */}
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                {/* TODO: Replace "Address coming soon" with real address */}
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-ink-light/40 rounded-2xl p-5 border border-cream-800/20">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center text-xs font-semibold px-5 py-2.5 bg-violet-600 text-white rounded-full hover:bg-violet-700 transition-colors w-full"
              >
                {t('ctaButton')}
              </Link>
            </div>
